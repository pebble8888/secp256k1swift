...
func Sigma0(_ x: UInt32) -> UInt32 { return (((x) >> 2 | (x) << 30) ^ ((x) >> 13 | (x) << 19) ^ ((x) >> 22 | (x) << 10)) }
func Sigma1(_ x: UInt32) -> UInt32 { return (((x) >> 6 | (x) << 26) ^ ((x) >> 11 | (x) << 21) ^ ((x) >> 25 | (x) << 7)) }
func sigma0(_ x: UInt32) -> UInt32 { return (((x) >> 7 | (x) << 25) ^ ((x) >> 18 | (x) << 14) ^ ((x) >> 3)) }
func sigma1(_ x: UInt32) -> UInt32 { return (((x) >> 17 | (x) << 15) ^ ((x) >> 19 | (x) << 13) ^ ((x) >> 10)) }
...
func BE32(_ p: UInt32) -> UInt32 { return ((((p) & 0xFF) << 24) | (((p) & 0xFF00) << 8) | (((p) & 0xFF0000) >> 8) | (((p) & 0xFF000000) >> 24)) }
...
func secp256k1_sha256_write(_ hash: inout secp256k1_sha256_t, _ data: [UInt8], _ len: UInt) {
    ...
    while (bufsize + len >= 64) {
        ...
        UInt8ToUInt32LE(&hash.buf, Int(bufsize/4), data, Int(data_pos), 64 - bufsize)
        data_pos += (64 - bufsize)
        len -= (64 - bufsize)
    ...
    if len > 0 {
        ...
        UInt8ToUInt32LE(&hash.buf, Int(bufsize/4), data, Int(data_pos), len)
    }
}
...
func secp256k1_sha256_finalize(_ hash: inout secp256k1_sha256_t, _ out32: inout [UInt8]) {
    ...
    UInt32LEToUInt8(&v, sizedesc)
    secp256k1_sha256_write(&hash, /*(const unsigned char*)sizedesc */ v, 8);
    for i in 0..<8 {
        out[i] = BE32(hash.s[i]);
        hash.s[i] = 0;
    }
